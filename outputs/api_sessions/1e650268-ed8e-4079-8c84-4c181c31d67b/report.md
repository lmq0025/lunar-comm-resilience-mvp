...
| `subnet_paralysis_probability` | 0 | 1 | 1 |
| `route_convergence_time_ms` | 0 | N/A | N/A |
| `relay_handover_delay_disturbance_ms` | 0 | 120 | 35 |
| `control_command_loss_rate` | 1.95799e-05 | 1 | 1 |
| `video_return_success_rate` | 0.999973 | 0 | 0 |
| `science_data_interruption_s` | 0 | 120 | 120 |
| `ka_channel_availability` | 0.99878 | 0 | 0 |
| `ka_configured_channel_availability` | 0.998305 | 0.748528 | 0.748528 |
| `ka_active_path_availability` | 0.99878 | 0 | 0 |
...
| after_healing | control_command | False | healing_verified_inherited | ground_station -> lunar_orbiter -> lander_main_hub -> rover_1 | inactive node lander_main_hub |
| after_healing | science_data | False | healing_verified_inherited | science_station -> lander_main_hub -> lunar_orbiter -> ground_station | inactive node lander_main_hub |
| after_healing | hd_video | False | healing_verified_inherited | camera_station -> lander_main_hub -> lunar_orbiter -> ground_station | inactive node lander_main_hub |
| after_healing | teleoperation | False | healing_verified_inherited | teleop_terminal -> lander_main_hub -> rover_2 | inactive node lander_main_hub |

## Fault Events

| Fault | Target | Start (s) | Duration (s) | Severity | Effect |
| --- | --- | ---: | ---: | ---: | --- |
| main_hub_failure | lander_main_hub | 30.0 | 25.0 | 0.95 | primary hub disabled; backup paths remain available for rerouting |
| dust_antenna_degradation | all_rf_links | 10.0 | 90.0 | 0.35 | RF links degraded by dust severity |
| relay_handover_delay | lunar_orbiter | 45.0 | 5.0 | 0.6 | relay handover disturbance set to 120.0 ms |
| buffer_overflow | edge_compute | 62.0 | 12.0 | 0.5 | congestion multiplier set to 2.20 |
...
- Relay handover disturbance delta: -85 ms
...
- Control command loss rate: 1
- HD video success rate: 0
- Science data interruption: 120 s

## Indicator Check

7/13 applicable technical indicators passed. Total configured indicators: 14.
...
| Indicator | Reason |
| --- | --- |
| Route convergence time | missing healing actions: reroute_backup_path |
