...
| `relay_handover_delay_disturbance_ms` | 0 | 40 | 35 |
...
| relay_handover_delay | lunar_orbiter | 45 | 5 | 0.6 | relay handover disturbance set to 40.0 ms |
...
- Relay handover disturbance delta: -5 ms
