...
| --- | ---: | ---: | ---: |
| `network_connectivity` | 1 | 0.416667 | 0.416667 |
...
| after_healing | control_command | False | reroute_backup_path |  | missing route |
| after_healing | science_data | False | reroute_backup_path |  | missing route |
| after_healing | hd_video | False | reroute_backup_path |  | missing route |
| after_healing | teleoperation | False | reroute_backup_path |  | missing route |
...
| reroute_backup_path | active_topology | False | inf | rerouted services: 0; failed services: 4; failed list: control_command, science_data, hd_video, teleoperation |
...
7/14 applicable technical indicators passed. Total configured indicators: 14.
