...
| `relay_handover_delay_disturbance_ms` | 0 | 120 | 120 |
...
| relay_handover_delay | lunar_orbiter | 45 | 5 | 0.6 | relay handover disturbance set to 120.0 ms |
...
- Relay handover disturbance: 120 ms
...
5/11 applicable technical indicators passed. Total configured indicators: 14.
...
| Service degradation decision time | missing healing actions: service_degradation |
| Science data return interruption | missing healing actions: store_and_forward |
